...
def main():
    ...
    with tf.Session() as sess:
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            predictions_list.append((fileName, classifications[sortedPredictions[0]], "{0:.5f}".format(predictions[0][sortedPredictions[0]])))
            # end for
    ...
    with open("predictions.csv", 'w') as f:
        correct_num = 0
        incorrect_num = 0
        f.write("filename" + "," + "class" + "," + "confidence" + ",correct/incorrect" + "\n")
        for prediction in predictions_list:
            if "virus" not in prediction[0] and "bacteria" not in prediction[0]:
                ...
                if prediction[1] == "normal":
                    ...
                    correct = "correct"
                    correct_num += 1
            f.write(prediction[0] + "," + prediction[1] + "," + prediction[2] + "," + correct + "\n")
        f.write("\n\ncorrect,incorrect\n" + str(correct_num) + "," + str(incorrect_num))
